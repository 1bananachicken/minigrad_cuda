#!/usr/bin/python3
# -*- coding: utf-8 -*-
# modified from https://github.com/hamlinzheng/mnist
import sys, os
import numpy as np
from dataset import load_mnist_images
...
# 初始化网络
network = Net()
network.load_state_dict('mnist_model.pth')
network.eval()
...
class MainWindow(QMainWindow,Ui_MainWindow):
    ...
    def pbtPredict_Callback(self):
        ...
        # reshape成网络输入类型 
        __result = network(img_array).data      # shape:[1, 10]
